...
<div>
    <div class="goods">
        <div class="menu-wrapper" ref='menuWrapper'>
            <ul>
                <li v-for="(menu,index) in goods" class="menu-item" :class="{'current':currentIndex===index}" @click="selectMenu(index,$event)">
                    <span class="text">
                        <span v-show="menu.type>0" class="icon" :class="classMap[menu.type]"></span>
                        {{menu.name}}
                    </span>
                </li>
            </ul>
